...
func TestIntegrationRootCommandCopiesExplicitStatePaths(t *testing.T) {
	t.Parallel()
...
func TestIntegrationRootCommandCopiesExplicitEnvironmentForPathResolution(t *testing.T) {
	t.Parallel()
...
func TestIntegrationRootCommandUsesProcessEnvironmentOnlyWhenNotSupplied(t *testing.T) {
