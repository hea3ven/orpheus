...
func TestIntegrationAttachedLauncherForwardsWorkingDirectoryArgumentsAndStreams(t *testing.T) {
	t.Parallel()
...
func TestIntegrationAttachedLauncherMissingExecutableDoesNotReportProcessStarted(t *testing.T) {
	t.Parallel()
	started := false
