...
func TestIntegrationInspectDetachedHEADUsesOriginDefaultBranch(t *testing.T) {
	repoPath := newGitRepo(t)
	runGit(t, repoPath, "remote", "add", "origin", "https://example.com/repo.git")
...
func TestIntegrationInspectMalformedOriginHEADFallsBackToCurrentBranch(t *testing.T) {
	repoPath := newGitRepo(t)
	runGit(t, repoPath, "remote", "add", "origin", "https://example.com/repo.git")
