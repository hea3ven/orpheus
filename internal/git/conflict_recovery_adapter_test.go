...
func TestIntegrationAdapterContractConflictRecoveryCommitsLocallyBeforeSeparatePush(t *testing.T) {
...
func TestIntegrationAdapterContractConflictRecoveryRollsBackOnlyMatchingCheckpoint(t *testing.T) {
