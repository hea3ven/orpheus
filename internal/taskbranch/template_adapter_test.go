...
func TestIntegrationAdapterContractRejectedRenderedBranchesFailGitCheckRefFormat(t *testing.T) {
...
func TestIntegrationAdapterContractRenderedBranchesPassGitCheckRefFormat(t *testing.T) {
	tests := []struct {
		name     string
		template string
