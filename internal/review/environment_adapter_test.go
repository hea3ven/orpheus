...
//nolint:testpackage // Exercises private review-command and Hunk process adapters directly.
package review
...
func TestIntegrationAdapterContractHunkNotesUseScopedEnvironment(t *testing.T) {
	t.Parallel()
...
func TestIntegrationAdapterContractReviewCommandUsesScopedEnvironment(t *testing.T) {
	t.Parallel()
