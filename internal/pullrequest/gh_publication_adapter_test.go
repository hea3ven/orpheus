...
func TestIntegrationAdapterContractGHProviderPublicationTranslatesIdentityAndBody(t *testing.T) {
...
func TestIntegrationAdapterContractGHProviderPublicationOutputAndFailures(t *testing.T) {
...
func TestIntegrationAdapterContractGHProviderStatusClassifiesRepositoryAndAuthenticationFailures(t *testing.T) {
